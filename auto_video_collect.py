            ...
            if self.capture.isOpened():
                ...
                if len(cnts_yel) > 0:
                    ...
                    if radius > 10:
                        ...
                        cv2.circle(self.frame, center_yel, 5, (0, 0, 255), -1)
                ...
                if len(cnts_white) > 0:
                    ...
                    if radius > 10:
                        ...
                        cv2.circle(self.frame, center_white, 5, (0, 0, 255), -1)
                ...
                for i in range(1, len(pts_white)):
                    ...
                    dist_white_red=np.sqrt(np.sum((p_white-p_yel)**2))
                    ##ball collision
                    if(dist_yel_white<=2*radius+10):
                        print("white/yellow", p_white, p_yel)   
                    if(dist_white_red<=2*radius+10):
                ...
                for i in range(1, len(pts_white)):
                    ...
                    if(p_white[0]==0 and p_white[1]>0):
                        print(p_white[0], width-radius)
                    #270degree
                    elif(p_white[0]==0 and p_white[1]<0):
                        print(p_white[0],radius)
                    #0 degree
                    elif(p_white[0]>0 and p_white[1]==0):
                        print(length-radius,p_white[1])
                    #180degree
                    elif(p_white[0]<0 and p_white[1]==0):
                        print(radius,p_white[1])
                    else:
                        ...
                        if(p_white[0]>=0 and p_white[1]>=0):
                            ...
                            if(y <= width-radius):
                                print(length-radius,y)
                            elif(x <= length-radius):
                                print(x, width-radius)
                        elif(p_white[0]>=0 and p_white[1]<=0):
